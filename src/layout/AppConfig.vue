...
const { layoutState, layoutConfig, isDarkTheme, toggleConfigSidebar } =
    useLayout();
...
function persistDarkMode(isDark) {
    AuthService.updateUiPreferences({ dark_mode: isDark })
        ...
        .catch(() => {
            /* preference stays in UI; will resync on next /me */
        });
}
                        ...
                        <div class="flex flex-wrap flex-col gap-4">
                            ...
                            <div class="flex items-center gap-2">
                                <RadioButton
                                    v-model="menuTheme"
                                    value="primaryColor"
                                    :checked="menuTheme === 'primaryColor'"
                                    name="menuTheme"
                                    @change="
                                        () =>
                                            (layoutConfig.menuTheme =
